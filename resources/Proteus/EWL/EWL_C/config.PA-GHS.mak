...
BASIC_ALIGN_4_CFLAGS			= --unsigned_chars -bigendian

BASIC_ALIGN_4_SOFT_CFLAGS		= -fsoft $(BASIC_ALIGN_4_CFLAGS)
BASIC_ALIGN_4_SPFP_SPE1_CFLAGS		= -SPE -fhard -isel $(BASIC_ALIGN_4_CFLAGS)
BASIC_ALIGN_4_SPFP_ONLY_SPE1_CFLAGS	= -floatsingle $(BASIC_ALIGN_4_SPFP_SPE1_CFLAGS)


$(E200z0_V_S_CONFIG)_CFLAGS		= -cpu=ppc560xp -vle -D__PPC_VLE__=1 $(BASIC_ALIGN_4_SOFT_CFLAGS)
$(E200z1_V_S_CONFIG)_CFLAGS		= -cpu=ppc5674m -vle -D__PPC_VLE__=1 $(BASIC_ALIGN_4_SOFT_CFLAGS)
$(E200z3_V_CONFIG)_CFLAGS		= -cpu=ppc5534  -vle -D__PPC_VLE__=1 $(BASIC_ALIGN_4_SPFP_SPE1_CFLAGS)
$(E200z3_V_SP_CONFIG)_CFLAGS		= -cpu=ppc5534  -vle -D__PPC_VLE__=1 $(BASIC_ALIGN_4_SPFP_ONLY_SPE1_CFLAGS)
$(E200z4_V_CONFIG)_CFLAGS		= -cpu=ppc564xl -vle -D__PPC_VLE__=1 $(BASIC_ALIGN_4_SPFP_SPE1_CFLAGS)
$(E200z4_V_SP_CONFIG)_CFLAGS		= -cpu=ppc564xl -vle -D__PPC_VLE__=1 $(BASIC_ALIGN_4_SPFP_ONLY_SPE1_CFLAGS)
$(E200z6_CONFIG)_CFLAGS			= -cpu=ppc5674m $(BASIC_ALIGN_4_SPFP_SPE1_CFLAGS)
$(E200z6_SP_CONFIG)_CFLAGS		= -cpu=ppc5674m $(BASIC_ALIGN_4_SPFP_ONLY_SPE1_CFLAGS)
$(E200z6_V_CONFIG)_CFLAGS		= -cpu=ppc5674m -vle -D__PPC_VLE__=1 $(BASIC_ALIGN_4_SPFP_SPE1_CFLAGS)
$(E200z6_V_SP_CONFIG)_CFLAGS		= -cpu=ppc5674m -vle -D__PPC_VLE__=1 $(BASIC_ALIGN_4_SPFP_ONLY_SPE1_CFLAGS)
$(E200z7_V_CONFIG)_CFLAGS		= -cpu=ppc5674m -vle -D__PPC_VLE__=1 $(BASIC_ALIGN_4_SPFP_SPE1_CFLAGS)
$(E200z7_V_SP_CONFIG)_CFLAGS		= -cpu=ppc5674m -vle -D__PPC_VLE__=1 $(BASIC_ALIGN_4_SPFP_ONLY_SPE1_CFLAGS)

TOOLS_ROOT = $(GHS_POWERPC_TOOLS)
TOOLS = $(TOOLS_ROOT)/multi520
CC = $(TOOLS)/ccppc
AR = $(TOOLS)/ax
...
PLATFORM_FLAGS	=   -D__PPC_EABI__=1  $(OPTS) -c $(SYSINCL)
