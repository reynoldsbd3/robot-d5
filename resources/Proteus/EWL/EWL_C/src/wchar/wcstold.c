...
#if _EWL_C99
ldbl_t _EWL_CDECL wcstold(const wchar_t * _EWL_RESTRICT str, wchar_t ** _EWL_RESTRICT end)
{
	...
	if (overflow || ((value != 0.0L) && ((abs_value < (ldbl_t)DBL_MIN) || (abs_value > (ldbl_t)DBL_MAX)))) {
