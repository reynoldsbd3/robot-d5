...
LIBMFLAGS = -D_EWL_BUILDING_LIBM=1 -lang=c99
ARFLAGS	=   -library
...
#
vpath % src/assert src/ctype src/errno src/ewl_printf src/locale src/math $(PLATFORM_SRCDIR) src/signal src/stdio src/stdlib src/strings src/sys src/wchar src/wctype
...
clean:
# Remove generated data files, e.g. EWL_C.PA_CmdLineData/* 
#
	-rm -rf $(OBJDATA_ROOT)
