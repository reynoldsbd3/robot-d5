...
INCLUDE = -D_GCCPORT_ -D__PPC_EABI__ -nostdinc -isystem $(INCLUDE_ROOT_EWL)/EWL_C/include 
INCLUDE += -isystem $(INCLUDE_ROOT_EWL)/EWL_C/src
INCLUDE += -isystem $(INCLUDE_ROOT_EWL)/EWL_C/include/sun_math 
INCLUDE += -isystem $(INCLUDE_ROOT_EWL)/EWL_Runtime/Runtime_PA/Include

# include makefiles that define common PA variables.
include $(INCLUDE_ROOT_EWL)/EWL_C/include/pa/EWL_DEFINES.PA-GCC.mak
...
TARGETS_RT = $(TRT_$(E200z0_V_S_CONFIG))
...
$(TARGETS) :
	@echo "Making $@"
	make -f EWL_Runtime.PA-GCC.mak TARGET=$@
endif
...
$(addprefix $(LIBOUT)/, $(addsuffix $(LIBTYPE),$(TARGET))) : $(ASMOBJECTS) $(COBJECTS) $(CPPOBJECTS) $(CPOBJECTS)
	...
	$(AR) $(ARFLAGS) $@ $(COBJECTS) $(CPPOBJECTS) $(CPOBJECTS) $(ASMOBJECTS)
