...
BASIC_ALIGN_4_SPFP_SPE1_CFLAGS		= -mspe -mabi=spe -mhard-float -mfloat-gprs=single -misel $(BASIC_ALIGN_4_CFLAGS)
BASIC_ALIGN_4_SPFP_ONLY_SPE1_CFLAGS	= -msingle-float $(BASIC_ALIGN_4_SPFP_SPE1_CFLAGS)


$(E200z0_V_S_CONFIG)_CFLAGS		= -mcpu=e200z0 -mvle -D__PPC_VLE__=1 -mregnames $(BASIC_ALIGN_4_SOFT_CFLAGS)
$(E200z1_V_S_CONFIG)_CFLAGS		= -mcpu=e200z1 -mvle -D__PPC_VLE__=1 -mregnames $(BASIC_ALIGN_4_SOFT_CFLAGS)
$(E200z3_V_CONFIG)_CFLAGS		= -mcpu=e200z3 -mvle -D__PPC_VLE__=1 -mregnames $(BASIC_ALIGN_4_SPFP_SPE1_CFLAGS)
$(E200z3_V_SP_CONFIG)_CFLAGS		= -mcpu=e200z3 -mvle -D__PPC_VLE__=1 -mregnames $(BASIC_ALIGN_4_SPFP_ONLY_SPE1_CFLAGS)
$(E200z4_V_CONFIG)_CFLAGS		= -mcpu=e200z4 -mvle -D__PPC_VLE__=1 -mregnames $(BASIC_ALIGN_4_SPFP_SPE1_CFLAGS)
$(E200z4_V_SP_CONFIG)_CFLAGS		= -mcpu=e200z4 -mvle -D__PPC_VLE__=1 -mregnames $(BASIC_ALIGN_4_SPFP_ONLY_SPE1_CFLAGS)
$(E200z6_CONFIG)_CFLAGS			= -mcpu=e200z6 -mregnames $(BASIC_ALIGN_4_SPFP_SPE1_CFLAGS)
$(E200z6_SP_CONFIG)_CFLAGS		= -mcpu=e200z6 -mregnames $(BASIC_ALIGN_4_SPFP_ONLY_SPE1_CFLAGS)
$(E200z6_V_CONFIG)_CFLAGS		= -mcpu=e200z6 -mvle -D__PPC_VLE__=1 -mregnames $(BASIC_ALIGN_4_SPFP_SPE1_CFLAGS)
$(E200z6_V_SP_CONFIG)_CFLAGS		= -mcpu=e200z6 -mvle -D__PPC_VLE__=1 -mregnames $(BASIC_ALIGN_4_SPFP_ONLY_SPE1_CFLAGS)
$(E200z7_V_CONFIG)_CFLAGS		= -mcpu=e200z7 -mvle -D__PPC_VLE__=1 -mregnames $(BASIC_ALIGN_4_SPFP_SPE1_CFLAGS)
$(E200z7_V_SP_CONFIG)_CFLAGS		= -mcpu=e200z7 -mvle -D__PPC_VLE__=1 -mregnames $(BASIC_ALIGN_4_SPFP_ONLY_SPE1_CFLAGS)

TOOLS_ROOT = $(POWERPC_TOOLS)
TOOLS = $(TOOLS_ROOT)/bin
CC = $(TOOLS)/powerpc-eabi-gcc
AR = $(TOOLS)/powerpc-eabi-ar
...
TC99_$(E200z0_V_S_CONFIG)CFLAGS = -std=c99 -include lib_c99.prefix -D_EWL_C_LOCALE_ONLY=1 $($(E200z0_V_S_CONFIG)_CFLAGS)
...
TC99_$(E200z1_V_S_CONFIG)CFLAGS = -std=c99 -include lib_c99.prefix -D_EWL_C_LOCALE_ONLY=1 $($(E200z1_V_S_CONFIG)_CFLAGS)
...
TC99_$(E200z3_V_SP_CONFIG)CFLAGS = -std=c99 -include lib_c99.prefix -D_EWL_C_LOCALE_ONLY=1 $($(E200z3_V_SP_CONFIG)_CFLAGS)
...
TC99_$(E200z4_V_SP_CONFIG)CFLAGS = -std=c99 -include lib_c99.prefix -D_EWL_C_LOCALE_ONLY=1 $($(E200z4_V_SP_CONFIG)_CFLAGS)
...
TC99_$(E200z6_SP_CONFIG)CFLAGS = -std=c99 -include lib_c99.prefix -D_EWL_C_LOCALE_ONLY=1 $($(E200z6_SP_CONFIG)_CFLAGS)
...
TC99_$(E200z6_V_SP_CONFIG)CFLAGS = -std=c99 -include lib_c99.prefix -D_EWL_C_LOCALE_ONLY=1 $($(E200z6_V_SP_CONFIG)_CFLAGS)
...
TC99_$(E200z7_V_SP_CONFIG)CFLAGS = -std=c99 -include lib_c99.prefix -D_EWL_C_LOCALE_ONLY=1 $($(E200z7_V_SP_CONFIG)_CFLAGS)
