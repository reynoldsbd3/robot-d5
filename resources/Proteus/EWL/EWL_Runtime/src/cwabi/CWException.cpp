...
/*	Return...:	---														*/
/************************************************************************/
extern terminate_handler set_terminate(terminate_handler handler) _EWL_NO_THROW  // hh 980102 added exception specific
{
...
/*	Return...:	---														*/
/************************************************************************/
extern unexpected_handler set_unexpected(unexpected_handler handler) _EWL_NO_THROW  // hh 980102 added exception specific
{
...
/************************************************************************/
#if !defined (__POWERPC__) && !defined(__STARCORE__) && !defined(__arm)
