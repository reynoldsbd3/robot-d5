...
extern "C" {
	_EWL_IMP_EXP_RUNTIME void * _EWL_CDECL __get_typeid(void *,long);
	_EWL_IMP_EXP_RUNTIME void * _EWL_CDECL __dynamic_cast(void *,long,type_info_struct *,type_info_struct *,short);
}
...
/************************************************************************/
void * _EWL_CDECL __get_typeid(void *obj,long offset)
{
//
...
/************************************************************************/
void * _EWL_CDECL __dynamic_cast(void *obj,long offset,type_info_struct *typeinfo,type_info_struct *subtypeinfo,short isref)
{
